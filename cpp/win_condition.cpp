...
int check_diag_right(char grid[SIZE][SIZE], int x, int y)
{
    char ch = grid[x][y];
...
int check_diag_left(char grid[SIZE][SIZE], int x, int y)
{
    char ch = grid[x][y];
...
int is_diag_win(char grid[SIZE][SIZE], int x, int y)
{
...
int is_column_win(char grid[SIZE][SIZE], int column)
{
    int row_1 = 0;
    int row_2 = 0;
